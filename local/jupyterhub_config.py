    ...
    def get_state_field(self, name):
        if name == "projects":
            ...
            projects = [
                ...
                ['https://github.com/gesiscss/data_science_image', 'gesiscss/singleuser-orc:r2d-49e91d9-2', 'master'] + ['gh/gesiscss/data_science_image-2', 'never']
            ]
            return projects
...
template_vars.update({
    "static_binder": "https://notebooks.gesis.org/services/binder/static/",
